...
package org.sf.feeling.swt.win32.extension.ole.flash;
...
import org.sf.feeling.swt.win32.extension.ole.OleObject;
...
/**
 * Adobe Flash Player ActiveX wrapper for SWT.
 * 
 * 
...
public class Flash extends OleContainer
{
	...
	public Flash( Composite parent, int style, FlashEventListener listener )
	{
		...
		catch ( Throwable ex )
		{
			...
			errorLabel.setForeground( ColorCache.getInstance( ).getColor( 255,
					0,
					0 ) );
			errorLabel.setText( "Create Flash control failed." );
		...
		oleControlSite.addEventListener( DISPID_FSCOMMAND, new OleListener( ) {
			...
			public void handleEvent( OleEvent event )
			{
				...
				{
					if ( flashListener != null )
						flashListener.onFSCommand( command.getString( ),
								args.getString( ) );
				}
			}
		} );
	 ...
	 * 
	 * Note: You can hard code the DISPIDs if you know them beforehand this is
	 * of course the fastest way, but you increase coupling to the control.
	 */
	 ...
	 *         READYSTATE_UNINITIALIZED; READYSTATE_LOADING; READYSTATE_LOADED;
	...
	{
		if ( created )
			return flashObject.setIntegerProperty( DISPID_BACKGROUNDCOLOR,
					value );
		else
			return false;
	}
	 ...
	 * </p>
	 * <p>
	 * The units of the coordinates are in twips (1440 units per inch). To
	 * calculate a rectangle in Flash, set the ruler units to Points and
	 * multiply the coordinates by 20 to get twips. There are 72 points per
	 * inch.
	 * </p>
	 */
	 ...
	 * </p>
	 * <p>
	 * You cannot specify a reduction in the size of objects in the view when
	 * the current view is already 100%.
	 * </p>
	 * 
	 * <pre>
	...
	/**
	 * <p>
	 * Pans a zoomed-in movie to the coordinates specified by x and y. Pan does
	 * not pan beyond the boundaries of the zoomed-in movie.
	 * </p>
	 * 
	 * @param mode
	 *            specifies whether the values for x and y are pixels (0) or
	 *            percents of window size (1).
	 */
	 ...
	 * If the data for a requested frame is not yet available, the player goes
	 * to the last frame available and stops, causing unexpected results during
	 * playback.
	 * </p>
	 * <p>
	 * Use the getPercentLoaded() method to determine if enough of the movie is
	 ...
	 * 
	 * @param frameNum
	 *            zero-based frame number to go to.
	 */
	...
	/**
	 * <p>
	 * Returns the percent (0 to 100) of the Flash Player movie that has
	 * streamed into the browser so far.
	 * </p>
	 */
	 ...
	 * 
	 * @param layer
	 *            target layer to play the movie in.
	 * @param url
	 *            URL or file path to movie.
	 */
	...
	/**
	 * <p>
	 * For the timeline indicated by target, goes to the frame number specified
	 * by frameNumber.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * For the timeline indicated by target, goes to the frame label specified
	 * by label.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Returns the number of the current frame for the timeline specified by
	 * target. Returned number is zero-based.
	 * </p>
	 * 
	 * <pre>
	...
	/**
	 * <p>
	 * Returns the label of the current frame of the timeline specified by
	 * target. If there is no current frame label, an empty string is returned.
	 * </p>
	 */
	...
	/**
	 * Sets the value of the Flash variable specified by name to the value
	 * specified by value.
	 */
	 ...
	 * 
	 * @param property
	 *            one of following: PROP_X_POS, PROP_Y_POS, PROP_X_SCALE,
	 *            PROP_Y_SCALE, PROP_ALPHA, PROP_VISIBLE, PROP_ROTATE,
	 *            PROP_NAME, PROP_HIGH_QUALITY, PROP_FOCUS_RECT,
	 *            PROP_SOUND_BUF_TIME
	 */
	...
	/**
	 * <p>
	 * For the timeline indicated by target, returns string value of a property.
	 * </p>
	 * 
	 * @param property
	 *            one of following: PROP_X_POS, PROP_Y_POS, PROP_X_SCALE,
	 *            PROP_Y_SCALE, PROP_CURRENT_FRAME, PROP_TOTAL_FRAMES,
	 *            PROP_ALPHA, PROP_VISIBLE, PROP_WIDTH, PROP_HEIGHT,
	 *            PROP_ROTATE, PROP_TARGET, PROP_FRAMES_LOADED, PROP_NAME,
	 *            PROP_DROP_TARGET, PROP_URL, PROP_HIGH_QUALITY,
	 *            PROP_FOCUS_RECT, PROP_SOUND_BUF_TIME
	 */
	...
	/**
	 * <p>
	 * In the timeline specified by target, executes the action in the frame
	 * specified by frameNum.
	 * </p>
	 * 
	 * <pre>
	...
	/**
	 * <p>
	 * In the Timeline indicated by target, executes the action in the frame
	 * specified by the label frame label.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * For the timeline indicated by target, returns numberic value of a
	 * property.
	 * </p>
	 * 
	 * @param property
