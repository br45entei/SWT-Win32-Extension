...
public class VS2003ThemeRender extends GeneralThemeRender {
	...
	protected void initRender() {
		...
		menu_item_bg_selected1 = ColorCache.getInstance().getColor(
				RGB_WIDGET_BACKGROUND);
		menu_item_bg_selected2 = menu_item_bg_selected1;
		...
		tool_item_showmenu_bg1 = ColorCache.getInstance().getColor(
				RGB_WIDGET_BACKGROUND);
		tool_item_showmenu_bg2 = ColorCache.getInstance().getColor(
				RGB_WIDGET_BACKGROUND);
		...
		menu_control_image_rect_fg = ColorCache.getInstance().getColor(
				RGB_WIDGET_BACKGROUND);
		menu_control_image_rect_bg = ColorCache.getInstance().getColor(
				RGB_WIDGET_BACKGROUND);
		...
		menu_control_item_check_rect_bg_track = COLOR_HIGHLIGHT_LIGHT;
		menu_control_item_check_rect_border_track = COLOR_HIGHLIGHT_FORELIGHT;
